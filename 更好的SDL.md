...
选择目标在你触及范围内的生物。进行一次对抗其力量对抗。目标体型每比你大1点，此次掷骰获得1点劣势。目标体型如果比你小，则获得1点优势。
...
将你的闪避属性和目标的攻击命中检定进行比较，若大于等于命中检定结果则闪避成功，视作你主动躲闪避开了目标的攻击，攻击无法造成伤害。
...
尝试进行快速飞扑，移动至多2码的距离，来逃出某些范围攻击的范围。

你可以自行选择落点，若落点在攻击范围外，则范围攻击不会影响你。
